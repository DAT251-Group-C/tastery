  ...
  <div v-if="recipe" class="small-view">
    <div class="flex flex-col gap-y-6">
      <div class="flex gap-2">
        ...
        <FavoriteButton v-if="isAuthenticated && user" :recipeId="id" :initialIsFavorite="isFavorite" />       
        <Button
...
import { toRefs, ref, watchEffect, watch, onMounted, computed } from 'vue';
import { useRouter } from 'vue-router';
import FavoriteButton from '@/views/recipe/FavoriteButton.vue';
