...
export class Migration1712416339779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ingredients" ADD CONSTRAINT "FK_519e426f525969e7088777249cd" FOREIGN KEY ("recipeId", "recipeId") REFERENCES "recipes"("id","userId") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
