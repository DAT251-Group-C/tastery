...
describe('FavoriteController', () => {
  ...
  describe('checkFavorite', () => {
    ...
    it('should handle errors by throwing BadRequestException', async () => {
      ...
      await expect(controller.checkFavorite('user1', 'recipe1'))
        .rejects
  ...
  describe('createFavorite', () => {
    ...
    it('should throw BadRequestException when creation fails', async () => {
        ...
        await expect(controller.createFavorite('user1', 'recipe1'))
            .rejects
            .toThrow(BadRequestException);
    });
  });
describe('deleteFavorite', () => {
    ...
    it('should throw NotFoundException if no favorite found', async () => {
        ...
        await expect(controller.deleteFavorite('user1', 'recipe1'))
            .rejects
